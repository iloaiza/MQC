...
const AbsTol = [1e-6,1e-6,1e-6,1e-6] #default absolute tolerances for rk45 adaptative timestep algorithm, follows RelTol conventions
const dt_min = 1e-3 #default minimum timestep for rk45 (1e-3 a.u. = 2.42e-5 fs)
const dt_max = 10.0 #default maximum timestep for rk45 (10 a.u. = 0.24 fs)
